...
By Proposition \ref{prop:unique nonsingular G in semibilinear form}, there exists a unique $2n\times 2n$ nonsingular matrix $J$ such that $\mathcal{S}(f,g) = Hf\cdot Jg$. Let $U^+, U_c^+$ be such that\todo{Is the direction correct? e.g., from the existence of $J$, construct $U^+$ and $U_c^+$.}
