...
\begin{rmk}
	...
	\DAS{Apply the unnumbered equation after~\eqref{eq:boundary form formula} to equation~\eqref{eq:adjoint boundary condition}. Because the RHS of equation~\qref{eq:adjoint boundary condition} is $0$ and $C^\star$ is linear, we still get $0$.}
\end{rmk}
